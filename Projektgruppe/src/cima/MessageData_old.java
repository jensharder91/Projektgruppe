...
//import cima.Gui;
//
//public class MessageData_old implements IMarkable{
//
...
//	private static MessageData_old displayCalcInfos;
...
//
//
//	public MessageData_old(){
//		this(0, null, null, null, null, null, 0, null, null,  null);
//	}
//	public MessageData_old(int lamdaValue, CIMAVertice sender, CIMAVertice receiver, CIMAEdgeWeight edge, IMarkable edgeMax1, IMarkable edgeMax2, int specialVerticeWeight, IMarkable maxMsgData, IMarkable msgEdge, PotentialData potentialData){
...
//	}
//	public MessageData_old(int lamdaValue, CIMAVertice sender, CIMAVertice receiver, int bestPossibleLamdaValue, CIMAEdgeWeight potentialEdge){
//		this.lamdaValue = lamdaValue;
//		this.sender = sender;
//		this.receiver = receiver;
...
//			MessageData_old.animationSpeed = animationSpeed;
//		}
//	}
...
//		MessageData_old.showMessageData = showMessageData;
//	}
